...
Y&&(K=f.rotateSpeed*f.momentumKeydownFactor)}}function l(a){Q=!1;K=L=0;if(!1!==f.enabled){switch(a.touches.length){case 1:if(!0===f.noRotate)return;x=w.TOUCH_ROTATE;E.set(a.touches[0].pageX,a.touches[0].pageY);break;case 2:if(!0===f.noZoom)return;x=w.TOUCH_DOLLY;var d=a.touches[0].pageX-a.touches[1].pageX;a=a.touches[0].pageY-a.touches[1].pageY;y.set(0,Math.sqrt(d*d+a*a));break;case 3:if(!0===f.noPan)return;x=w.TOUCH_PAN;n.set(a.touches[0].pageX,a.touches[0].pageY);break;default:x=w.NONE}x!==w.NONE&&
f.dispatchEvent(O)}}function v(a){if(!1!==f.enabled){a.preventDefault();a.stopPropagation();var d=f.domElement===document?f.domElement.body:f.domElement;switch(a.touches.length){case 1:if(!0===f.noRotate)break;if(x!==w.TOUCH_ROTATE)break;k.set(a.touches[0].pageX,a.touches[0].pageY);r.subVectors(k,E);f.rotateLeft(2*Math.PI*r.x/d.clientWidth*f.rotateSpeed);f.rotateUp(2*Math.PI*r.y/d.clientHeight*f.rotateSpeed);E.copy(k);G&&(K=a.touches[0].pageX-G.pageX,L=a.touches[0].pageY-G.pageY);G={pageX:a.touches[0].pageX,
...
d.copy(this.target).add(A);this.object.lookAt(this.target);B=C=0;D=1;F.set(0,0,0);if(1E-7<M.distanceToSquared(this.object.position)||1E-7<8*(1-N.dot(this.object.quaternion)))!0!==a&&this.dispatchEvent(V),M.copy(this.object.position),N.copy(this.object.quaternion)};this.reset=function(){x=w.NONE;this.target.copy(this.target0);this.object.position.copy(this.position0);this.object.zoom=this.zoom0;this.object.updateProjectionMatrix();this.dispatchEvent(V);this.update()};this.getPolarAngle=function(){return H};
this.getAzimuthalAngle=function(){return R};this.connect=function(){this.domElement.addEventListener("mousedown",c,{passive:!1});this.domElement.addEventListener("mousewheel",h,{passive:!1});this.domElement.addEventListener("DOMMouseScroll",h,{passive:!1});this.domElement.addEventListener("touchstart",l,{passive:!1});this.domElement.addEventListener("touchend",q,{passive:!1});this.domElement.addEventListener("touchmove",v,{passive:!1});window.addEventListener("keyup",p,{passive:!1});window.addEventListener("keydown",
m,{passive:!1})};this.disconnect=function(){this.domElement.removeEventListener("mousedown",c);this.domElement.removeEventListener("mousewheel",h);this.domElement.removeEventListener("DOMMouseScroll",h);this.domElement.removeEventListener("touchstart",l);this.domElement.removeEventListener("touchend",q);this.domElement.removeEventListener("touchmove",v);window.removeEventListener("keyup",p);window.removeEventListener("keydown",m)};this.dispose=function(){this.disconnect()};this.update()}function ca(a,
b){var c=this,d={type:"change"},g=0,h=0,p=0,m=0;this.camera=a;this.camera.rotation.reorder("YXZ");this.domElement=void 0!==b?b:document;this.enabled=!0;this.gyroPermissionGranted=!1;this.deviceOrientation={};this.alphaOffsetAngle=this.alpha=this.screenOrientation=0;var l=function(a){c.deviceOrientation=a},v=function(){c.screenOrientation=window.orientation||0},q=function(a){a.preventDefault();a.stopPropagation();p=a.touches[0].pageX;m=a.touches[0].pageY},f=function(a){a.preventDefault();a.stopPropagation();
g+=e.Math.degToRad((a.touches[0].pageX-p)/4);h+=e.Math.degToRad((m-a.touches[0].pageY)/4);c.updateAlphaOffsetAngle(g);p=a.touches[0].pageX;m=a.touches[0].pageY};this.connect=function(){v();window.addEventListener("orientationchange",v,{passive:!0});window.addEventListener("deviceorientation",l,{passive:!0});window.addEventListener("deviceorientation",this.update.bind(this),{passive:!0});this.domElement.addEventListener("touchstart",q,{passive:!1});this.domElement.addEventListener("touchmove",f,{passive:!1});
this.enabled=!0};this.disconnect=function(){window.removeEventListener("orientationchange",v,!1);window.removeEventListener("deviceorientation",l,!1);window.removeEventListener("deviceorientation",this.update.bind(this),!1);c.domElement.removeEventListener("touchstart",q,!1);c.domElement.removeEventListener("touchmove",f,!1);c.enabled=!1};this.update=function(a){if(!1!==c.enabled){var b=c.deviceOrientation.alpha?e.Math.degToRad(c.deviceOrientation.alpha)+c.alphaOffsetAngle:0,g=c.deviceOrientation.beta?
e.Math.degToRad(c.deviceOrientation.beta):0,f=c.deviceOrientation.gamma?e.Math.degToRad(c.deviceOrientation.gamma):0,p=c.screenOrientation?e.Math.degToRad(c.screenOrientation):0,m=c.camera.quaternion,l=new e.Vector3(0,0,1),E=new e.Euler,q=new e.Quaternion,v=new e.Quaternion(-Math.sqrt(.5),0,0,Math.sqrt(.5)),k=new e.Quaternion,r=new e.Quaternion;if(0==c.screenOrientation){var n=new e.Vector3(1,0,0);k.setFromAxisAngle(n,-h)}else 180==c.screenOrientation?(n=new e.Vector3(1,0,0),k.setFromAxisAngle(n,
h)):90==c.screenOrientation?(n=new e.Vector3(0,1,0),k.setFromAxisAngle(n,h)):-90==c.screenOrientation&&(n=new e.Vector3(0,1,0),k.setFromAxisAngle(n,-h));v.multiply(k);v.multiply(r);E.set(g,b,-f,"YXZ");m.setFromEuler(E);m.multiply(v);m.multiply(q.setFromAxisAngle(l,-p));c.alpha=b;!0!==a&&c.dispatchEvent(d)}};this.updateAlphaOffsetAngle=function(a){this.alphaOffsetAngle=a;this.update()};this.dispose=function(){this.disconnect()}}function ha(a){var b=new e.OrthographicCamera(-1,1,1,-1,0,1),c=new e.Scene,
d=new e.StereoCamera;d.aspect=.5;var g=new e.WebGLRenderTarget(512,512,{minFilter:e.LinearFilter,magFilter:e.NearestFilter,format:e.RGBAFormat});g.scissorTest=!0;g.texture.generateMipmaps=!1;var h=new e.Vector2(.441,.156),p=(new e.PlaneBufferGeometry(1,1,10,20)).removeAttribute("normal").toNonIndexed(),m=p.attributes.position.array,l=p.attributes.uv.array;p.attributes.position.count*=2;p.attributes.uv.count*=2;var v=new Float32Array(2*m.length);v.set(m);v.set(m,m.length);var q=new Float32Array(2*
l.length);q.set(l);q.set(l,l.length);l=new e.Vector2;m=m.length/3;for(var f=0,E=v.length/3;f<E;f++){l.x=v[3*f];l.y=v[3*f+1];var k=l.dot(l);k=1.5+(h.x+h.y*k)*k;var n=f<m?0:1;v[3*f]=l.x/k*1.5-.5+n;v[3*f+1]=l.y/k*3;q[2*f]=.5*(q[2*f]+n)}p.attributes.position.array=v;p.attributes.uv.array=q;h=new e.MeshBasicMaterial({map:g.texture});p=new e.Mesh(p,h);c.add(p);this.setSize=function(d,b){a.setSize(d,b);var c=a.getPixelRatio();g.setSize(d*c,b*c)};this.render=function(h,f){h.updateMatrixWorld();null===f.parent&&
f.updateMatrixWorld();d.update(f);f=g.width/2;var e=g.height;a.autoClear&&a.clear();g.scissor.set(0,0,f,e);g.viewport.set(0,0,f,e);a.setRenderTarget(g);a.render(h,d.cameraL);a.clearDepth();g.scissor.set(f,0,f,e);g.viewport.set(f,0,f,e);a.setRenderTarget(g);a.render(h,d.cameraR);a.clearDepth();a.setRenderTarget(null);a.render(c,b)}}function da(a){a=a||{};a.controlBar=void 0!==a.controlBar?a.controlBar:!0;a.controlButtons=a.controlButtons||["fullscreen","setting","video"];a.autoHideControlBar=void 0!==
a.autoHideControlBar?a.autoHideControlBar:!1;a.autoHideInfospot=void 0!==a.autoHideInfospot?a.autoHideInfospot:!0;a.horizontalView=void 0!==a.horizontalView?a.horizontalView:!1;a.clickTolerance=a.clickTolerance||10;a.cameraFov=a.cameraFov||60;a.reverseDragging=a.reverseDragging||!1;a.enableReticle=a.enableReticle||!1;a.dwellTime=a.dwellTime||1500;a.autoReticleSelect=void 0!==a.autoReticleSelect?a.autoReticleSelect:!0;a.viewIndicator=void 0!==a.viewIndicator?a.viewIndicator:!1;a.indicatorSize=a.indicatorSize||
30;a.output=a.output?a.output:"none";a.autoRotate=a.autoRotate||!1;a.autoRotateSpeed=a.autoRotateSpeed||2;a.autoRotateActivationDuration=a.autoRotateActivationDuration||5E3;a.autoCentre=a.autoCentre||!1;a.defaultControlIndex=void 0!==a.defaultControlIndex?a.defaultControlIndex:D.ORBIT;this.options=a;if(a.container){var b=a.container;b._width=b.clientWidth;b._height=b.clientHeight}else b=document.createElement("div"),b.classList.add("panolens-container"),b.style.width="100%",b.style.height="100%",
b._width=window.innerWidth,b._height=window.innerHeight,document.body.appendChild(b);this.container=b;this.camera=a.camera||new e.PerspectiveCamera(this.options.cameraFov,this.container.clientWidth/this.container.clientHeight,1,1E4);this.scene=a.scene||new e.Scene;this.renderer=a.renderer||new e.WebGLRenderer({alpha:!0,antialias:!1});this.sceneReticle=new e.Scene;this.viewIndicatorSize=this.options.indicatorSize;this.reticle={};this.tempEnableReticle=this.options.enableReticle;this.mode=t.NORMAL;
...
this.options.autoRotate;this.OrbitControls.autoRotateSpeed=this.options.autoRotateSpeed;this.DeviceOrientationControls=new ca(this.camera,this.container);this.DeviceOrientationControls.id="device-orientation";this.DeviceOrientationControls.enabled=!1;this.camera.position.z=1;this.options.passiveRendering&&console.warn("passiveRendering is now deprecated");this.controls=[this.OrbitControls,this.DeviceOrientationControls];this.CardboardEffect=new ha(this.renderer);this.CardboardEffect.setSize(this.container.clientWidth,
...
this.options.enableReticle?this.enableReticleControl():this.registerMouseAndTouchEvents();"overlay"===this.options.output&&this.addOutputElement();this.registerEventListeners();this.enableControl(a.defaultControlIndex);this.animate.call(this)}var ja="^0.105.2".replace(/[^0-9.]/g,""),D={ORBIT:0,DEVICEORIENTATION:1},t={UNKNOWN:0,NORMAL:1,CARDBOARD:2,STEREO:3},u={Info:"data:image/png;base64,",
...
1/2.75?7.5625*a*a:a<2/2.75?7.5625*(a-=1.5/2.75)*a+.75:a<2.5/2.75?7.5625*(a-=2.25/2.75)*a+.9375:7.5625*(a-=2.625/2.75)*a+.984375},InOut:function(a){return.5>a?.5*c.Easing.Bounce.In(2*a):.5*c.Easing.Bounce.Out(2*a-1)+.5}}};c.Interpolation={Linear:function(a,b){var d=a.length-1,g=d*b,e=Math.floor(g),l=c.Interpolation.Utils.Linear;return 0>b?l(a[0],a[1],g):1<b?l(a[d],a[d-1],d-g):l(a[e],a[e+1>d?d:e+1],g-e)},Bezier:function(a,b){for(var d=0,g=a.length-1,e=Math.pow,l=c.Interpolation.Utils.Bernstein,k=0;k<=
g;k++)d+=e(1-b,g-k)*e(b,k)*a[k]*l(g,k);return d},CatmullRom:function(a,b){var d=a.length-1,g=d*b,e=Math.floor(g),l=c.Interpolation.Utils.CatmullRom;return a[0]===a[d]?(0>b&&(e=Math.floor(g=d*(1+b))),l(a[(e-1+d)%d],a[e],a[(e+1)%d],a[(e+2)%d],g-e)):0>b?a[0]-(l(a[0],a[0],a[1],a[1],-g)-a[0]):1<b?a[d]-(l(a[d],a[d],a[d-1],a[d-1],g-d)-a[d]):l(a[e?e-1:0],a[e],a[d<e+1?d:e+1],a[d<e+2?d:e+2],g-e)},Utils:{Linear:function(a,b,c){return(b-a)*c+a},Bernstein:function(a,b){var d=c.Interpolation.Utils.Factorial;return d(a)/
...
createVideoControlSeekbar:function(){function a(a){a.stopPropagation();h=!0;p=a.clientX||a.changedTouches&&a.changedTouches[0].clientX;m=parseInt(k.style.width)/100;e.container.addEventListener("mousemove",b,{passive:!0});e.container.addEventListener("mouseup",c,{passive:!0});e.container.addEventListener("touchmove",b,{passive:!0});e.container.addEventListener("touchend",c,{passive:!0})}function b(a){h&&(l=((a.clientX||a.changedTouches&&a.changedTouches[0].clientX)-p)/f.clientWidth,l=m+l,l=1<l?1:
0>l?0:l,f.setProgress(l),e.dispatchEvent({type:"panolens-viewer-handler",method:"setVideoCurrentTime",data:l}))}function c(a){a.stopPropagation();h=!1;d()}function d(){e.container.removeEventListener("mousemove",b,!1);e.container.removeEventListener("mouseup",c,!1);e.container.removeEventListener("touchmove",b,!1);e.container.removeEventListener("touchend",c,!1)}var e=this,h=!1,p,m,l;var k=document.createElement("div");k.style.width="0%";k.style.height="100%";k.style.backgroundColor="#fff";var q=
document.createElement("div");q.style.float="right";q.style.width="14px";q.style.height="14px";q.style.transform="translate(7px, -5px)";q.style.borderRadius="50%";q.style.backgroundColor="#ddd";q.addEventListener("mousedown",a,{passive:!0});q.addEventListener("touchstart",a,{passive:!0});k.appendChild(q);var f=this.createCustomItem({style:{float:"left",width:"30%",height:"4px",marginTop:"20px",backgroundColor:"rgba(188,188,188,0.8)"},onTap:function(a){a.preventDefault();a.stopPropagation();if(a.target!==
q){var b=a.changedTouches&&0<a.changedTouches.length?(a.changedTouches[0].pageX-a.target.getBoundingClientRect().left)/this.clientWidth:a.offsetX/this.clientWidth;e.dispatchEvent({type:"panolens-viewer-handler",method:"setVideoCurrentTime",data:b});f.setProgress(a.offsetX/this.clientWidth)}},onDispose:function(){d();q=k=null}});f.appendChild(k);f.setProgress=function(a){k.style.width=100*a+"%"};this.addEventListener("video-update",function(a){f.setProgress(a.percentage)});f.progressElement=k;f.progressElementControl=
...
this.raycaster.intersectObject(this.panorama,!0);if(0<a.length){a=a[0].point.clone();var b=new e.Vector3(-1,1,1),c=this.panorama.getWorldPosition(new e.Vector3);a.sub(c).multiply(b);b=a.x.toFixed(2)+", "+a.y.toFixed(2)+", "+a.z.toFixed(2);if(0!==a.length())switch(this.options.output){case "console":console.info(b);break;case "overlay":this.outputDivElement.textContent=b}}},onMouseDown:function(a){a.preventDefault();this.userMouse.x=0<=a.clientX?a.clientX:a.touches[0].clientX;this.userMouse.y=0<=a.clientY?
a.clientY:a.touches[0].clientY;this.userMouse.type="mousedown";this.onTap(a)},onMouseMove:function(a){a.preventDefault();this.userMouse.type="mousemove";this.onTap(a)},onMouseUp:function(a){this.userMouse.type="mouseup";var b=this.userMouse.x>=a.clientX-this.options.clickTolerance&&this.userMouse.x<=a.clientX+this.options.clickTolerance&&this.userMouse.y>=a.clientY-this.options.clickTolerance&&this.userMouse.y<=a.clientY+this.options.clickTolerance||a.changedTouches&&this.userMouse.x>=a.changedTouches[0].clientX-
this.options.clickTolerance&&this.userMouse.x<=a.changedTouches[0].clientX+this.options.clickTolerance&&this.userMouse.y>=a.changedTouches[0].clientY-this.options.clickTolerance&&this.userMouse.y<=a.changedTouches[0].clientY+this.options.clickTolerance?"click":void 0;if(!a||!a.target||a.target.classList.contains("panolens-canvas"))if(a.preventDefault(),a=a.changedTouches&&1===a.changedTouches.length?this.onTap({clientX:a.changedTouches[0].clientX,clientY:a.changedTouches[0].clientY},b):this.onTap(a,
b),this.userMouse.type="none",!a&&"click"===b){b=this.options;a=b.autoHideControlBar;var c=this.panorama,d=this.toggleControlBar;b.autoHideInfospot&&c&&c.toggleInfospotVisibility();a&&d()}},onTap:function(a,b){var c=this.container.getBoundingClientRect(),d=c.top,e=this.container,h=e.clientHeight;this.raycasterPoint.x=(a.clientX-c.left)/e.clientWidth*2-1;this.raycasterPoint.y=2*-((a.clientY-d)/h)+1;this.raycaster.setFromCamera(this.raycasterPoint,this.camera);if(this.panorama){("mousedown"!==a.type&&
...
1;0<=c;c--)a(b.children[c]),b.remove(b.children[c]);b instanceof n||b instanceof z?b.dispose():b.dispatchEvent&&b.dispatchEvent("dispose")}this.tweenLeftAnimation.stop();this.tweenUpAnimation.stop();this.unregisterEventListeners();a(this.scene);this.widget&&(this.widget.dispose(),this.widget=null);e.Cache&&e.Cache.enabled&&e.Cache.clear()},destroy:function(){this.dispose();this.render();window.cancelAnimationFrame(this.requestAnimationId)},onPanoramaDispose:function(a){a instanceof B&&this.hideVideoWidget();
...
return b},clearAllCache:function(){e.Cache.clear()}});"105"!=e.REVISION&&console.warn("three.js version is not matched. Please consider use the target revision 105");window.TWEEN=r;k.BasicPanorama=O;k.CONTROLS=D;k.CameraPanorama=J;k.CubePanorama=F;k.CubeTextureLoader=fa;k.DataImage=u;k.EmptyPanorama=W;k.GoogleStreetviewPanorama=Z;k.ImageLittlePlanet=aa;k.ImageLoader=ea;k.ImagePanorama=y;k.Infospot=z;k.LittlePlanet=C;k.MODES=t;k.Media=S;k.Panorama=n;k.REVISION="14";k.Reticle=M;k.THREE_REVISION="105";
k.THREE_VERSION=ja;k.TextureLoader=N;k.VERSION="0.14.0";k.VideoPanorama=B;k.Viewer=da;k.Widget=I;Object.defineProperty(k,"__esModule",{value:!0})});
