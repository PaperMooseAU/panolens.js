...
this.startTimestamp=null;this.frustumCulled=!1;this.updateCanvasArcByProgress(0)}function z(a,b,c){var d=this;a=void 0===a?300:a;b=b||u.Info;e.Sprite.call(this);this.type="infospot";this.animated=void 0!==c?c:!0;this.frustumCulled=this.isHovering=!1;this.cursorStyle=this.toPanorama=this.element=null;this.mode=t.NORMAL;this.scale.set(a,a,1);this.rotation.y=Math.PI;this.container=null;this.originalRaycast=this.raycast;this.HANDLER_FOCUS=null;this.material.side=e.DoubleSide;this.material.depthTest=!1;
...
500).easing(r.Easing.Elastic.Out);this.material.map=d;this.material.needsUpdate=!0}}.bind(this);this.showAnimation=(new r.Tween(this.material)).to({opacity:1},500).onStart(this.enableRaycast.bind(this,!0)).onStart(function(){d.dispatchEvent({type:"show-start"})}).onComplete(function(){d.dispatchEvent({type:"show-complete"})}).easing(r.Easing.Quartic.Out);this.hideAnimation=(new r.Tween(this.material)).to({opacity:0},500).onStart(this.enableRaycast.bind(this,!1)).onStart(function(){d.dispatchEvent({type:"hide-start"})}).onComplete(function(){d.dispatchEvent({type:"hide-complete"})}).easing(r.Easing.Quartic.Out);
this.addEventListener("click",this.onClick);this.addEventListener("hover",this.onHover);this.addEventListener("hoverenter",this.onHoverStart);this.addEventListener("hoverleave",this.onHoverEnd);this.addEventListener("panolens-dual-eye-effect",this.onDualEyeEffect);this.addEventListener("panolens-container",this.setContainer.bind(this));this.addEventListener("dismiss",this.onDismiss);this.addEventListener("panolens-infospot-focus",this.setFocusMethod);N.load(b,c)}function I(a){a||console.warn("PANOLENS.Widget: No container specified");
e.EventDispatcher.call(this);this.DEFAULT_TRANSITION="all 0.27s ease";this.TOUCH_ENABLED=!!("ontouchstart"in window||window.DocumentTouch&&document instanceof DocumentTouch);this.PREVENT_EVENT_HANDLER=function(a){a.preventDefault();a.stopPropagation()};this.container=a;this.mask=this.activeSubMenu=this.activeMainItem=this.mainMenu=this.settingElement=this.videoElement=this.fullscreenElement=this.barElement=null}function n(a,b){e.Object3D.call(this);this.background=new e.Mesh(a,b);this.background.renderOrder=
-1;this.background.scale.x=-1;this.add(this.background);this.type="panorama";this.ImageQualityLow=1;this.ImageQualityFair=2;this.ImageQualityMedium=3;this.ImageQualityHigh=4;this.ImageQualitySuperHigh=5;this.animationDuration=1E3;this.defaultInfospotSize=350;this.container=void 0;this.loaded=!1;this.linkedSpots=[];this.isInfospotVisible=!1;this.linkingImageScale=this.linkingImageURL=void 0;this.background.material.side=e.BackSide;this.background.material.opacity=0;this.active=!1;this.infospotAnimation=
(new r.Tween(this)).to({},this.animationDuration/2);this.addEventListener("load",this.fadeIn.bind(this));this.addEventListener("panolens-container",this.setContainer.bind(this));this.addEventListener("click",this.onClick.bind(this));this.setupTransitions()}function y(a,b,c){b=b||new e.SphereBufferGeometry(5E3,60,40);c=c||new e.MeshBasicMaterial({opacity:0,transparent:!0});n.call(this,b,c);this.src=a;this.radius=5E3}function W(){var a=new e.BufferGeometry,b=new e.MeshBasicMaterial({color:0,opacity:0,
transparent:!0});a.addAttribute("position",new e.BufferAttribute(new Float32Array,1));n.call(this,a,b)}function F(a){a=void 0===a?[]:a;var b=Object.assign({},e.ShaderLib.cube),c=new e.BoxBufferGeometry(1E4,1E4,1E4);b=new e.ShaderMaterial({fragmentShader:b.fragmentShader,vertexShader:b.vertexShader,uniforms:b.uniforms,side:e.BackSide,transparent:!0});n.call(this,c,b);this.images=a;this.edgeLength=1E4;this.background.material.uniforms.opacity.value=0}function O(){for(var a=[],b=0;6>b;b++)a.push(u.WhiteTile);
F.call(this,a)}function B(a,b){b=void 0===b?{}:b;var c=new e.SphereBufferGeometry(5E3,60,40),d=new e.MeshBasicMaterial({opacity:0,transparent:!0});n.call(this,c,d);this.src=a;this.options={videoElement:document.createElement("video"),loop:!0,muted:!0,autoplay:!1,playsinline:!0,crossOrigin:"anonymous"};Object.assign(this.options,b);this.videoElement=this.options.videoElement;this.videoProgress=0;this.radius=5E3;this.addEventListener("leave",this.pauseVideo.bind(this));this.addEventListener("enter-fade-start",
this.resumeVideoProgress.bind(this));this.addEventListener("video-toggle",this.toggleVideo.bind(this));this.addEventListener("video-time",this.setVideoCurrentTime.bind(this))}function P(a){this._parameters=a=void 0===a?{}:a;this._panoId=this._zoom=null;this._panoClient=new google.maps.StreetViewService;this._total=this._count=0;this._canvas=[];this._ctx=[];this._hc=this._wc=0;this.result=null;this.rotation=0;this.copyright="";this.onPanoramaLoad=this.onSizeChange=null;this.levelsW=[1,2,4,7,13,26];
this.levelsH=[1,1,2,4,7,13];this.widths=[416,832,1664,3328,6656,13312];this.heights=[416,416,832,1664,3328,6656];this.maxH=this.maxW=6656;var b;try{var c=document.createElement("canvas");(b=c.getContext("experimental-webgl"))||(b=c.getContext("webgl"))}catch(d){}this.maxW=Math.max(b.getParameter(b.MAX_TEXTURE_SIZE),this.maxW);this.maxH=Math.max(b.getParameter(b.MAX_TEXTURE_SIZE),this.maxH)}function Z(a,b){y.call(this);this.panoId=a;this.gsvLoader=null;this.loadRequested=!1;this.setupGoogleMapAPI(b)}
...
function aa(a,b,c){C.call(this,"image",a,b,c)}function J(a){var b=new e.SphereBufferGeometry(5E3,60,40),c=new e.MeshBasicMaterial({visible:!1});n.call(this,b,c);this.media=new S(a);this.radius=5E3;this.addEventListener("enter",this.start.bind(this));this.addEventListener("leave",this.stop.bind(this));this.addEventListener("panolens-container",this.onPanolensContainer.bind(this));this.addEventListener("panolens-scene",this.onPanolensScene.bind(this))}function ba(a,b){function c(a){Q=!1;K=L=0;if(!1!==
f.enabled){a.preventDefault();if(a.button===f.mouseButtons.ORBIT){if(!0===f.noRotate)return;x=w.ROTATE;E.set(a.clientX,a.clientY)}else if(a.button===f.mouseButtons.ZOOM){if(!0===f.noZoom)return;x=w.DOLLY;y.set(a.clientX,a.clientY)}else if(a.button===f.mouseButtons.PAN){if(!0===f.noPan)return;x=w.PAN;n.set(a.clientX,a.clientY)}x!==w.NONE&&(document.addEventListener("mousemove",d,!1),document.addEventListener("mouseup",g,!1),f.dispatchEvent(O));f.update()}}function d(a){if(!1!==f.enabled){a.preventDefault();
var d=f.domElement===document?f.domElement.body:f.domElement;if(x===w.ROTATE){if(!0===f.noRotate)return;h.set(a.clientX,a.clientY);r.subVectors(h,E);f.rotateLeft(2*Math.PI*r.x/d.clientWidth*f.rotateSpeed);f.rotateUp(2*Math.PI*r.y/d.clientHeight*f.rotateSpeed);E.copy(h);G&&(K=a.clientX-G.clientX,L=a.clientY-G.clientY);G=a}else if(x===w.DOLLY){if(!0===f.noZoom)return;z.set(a.clientX,a.clientY);T.subVectors(z,y);0<T.y?f.dollyIn():0>T.y&&f.dollyOut();y.copy(z)}else if(x===w.PAN){if(!0===f.noPan)return;
U.set(a.clientX,a.clientY);t.subVectors(U,n);f.pan(t.x,t.y);n.copy(U)}x!==w.NONE&&f.update()}}function g(){Q=!0;G=void 0;!1!==f.enabled&&(document.removeEventListener("mousemove",d,!1),document.removeEventListener("mouseup",g,!1),f.dispatchEvent(P),x=w.NONE)}function k(a){if(!1!==f.enabled&&!0!==f.noZoom&&x===w.NONE){a.preventDefault();a.stopPropagation();var d=0;void 0!==a.wheelDelta?d=a.wheelDelta:void 0!==a.detail&&(d=-a.detail);0<d?(f.object.fov=f.object.fov<f.maxFov?f.object.fov+1:f.maxFov,f.object.updateProjectionMatrix()):
0>d&&(f.object.fov=f.object.fov>f.minFov?f.object.fov-1:f.minFov,f.object.updateProjectionMatrix());f.update();f.dispatchEvent(V);f.dispatchEvent(O);f.dispatchEvent(P)}}function p(a){switch(a.keyCode){case f.keys.UP:I=!1;break;case f.keys.BOTTOM:J=!1;break;case f.keys.LEFT:X=!1;break;case f.keys.RIGHT:Y=!1}}function m(a){if(!1!==f.enabled&&!0!==f.noKeys&&!0!==f.noRotate){switch(a.keyCode){case f.keys.UP:I=!0;break;case f.keys.BOTTOM:J=!0;break;case f.keys.LEFT:X=!0;break;case f.keys.RIGHT:Y=!0}if(I||
J||X||Y)Q=!0,I&&(L=-f.rotateSpeed*f.momentumKeydownFactor),J&&(L=f.rotateSpeed*f.momentumKeydownFactor),X&&(K=-f.rotateSpeed*f.momentumKeydownFactor),Y&&(K=f.rotateSpeed*f.momentumKeydownFactor)}}function l(a){Q=!1;K=L=0;if(!1!==f.enabled){switch(a.touches.length){case 1:if(!0===f.noRotate)return;x=w.TOUCH_ROTATE;E.set(a.touches[0].pageX,a.touches[0].pageY);break;case 2:if(!0===f.noZoom)return;x=w.TOUCH_DOLLY;var d=a.touches[0].pageX-a.touches[1].pageX;a=a.touches[0].pageY-a.touches[1].pageY;y.set(0,
Math.sqrt(d*d+a*a));break;case 3:if(!0===f.noPan)return;x=w.TOUCH_PAN;n.set(a.touches[0].pageX,a.touches[0].pageY);break;default:x=w.NONE}x!==w.NONE&&f.dispatchEvent(O)}}function v(a){if(!1!==f.enabled){a.preventDefault();a.stopPropagation();var d=f.domElement===document?f.domElement.body:f.domElement;switch(a.touches.length){case 1:if(!0===f.noRotate)break;if(x!==w.TOUCH_ROTATE)break;h.set(a.touches[0].pageX,a.touches[0].pageY);r.subVectors(h,E);f.rotateLeft(2*Math.PI*r.x/d.clientWidth*f.rotateSpeed);
f.rotateUp(2*Math.PI*r.y/d.clientHeight*f.rotateSpeed);E.copy(h);G&&(K=a.touches[0].pageX-G.pageX,L=a.touches[0].pageY-G.pageY);G={pageX:a.touches[0].pageX,pageY:a.touches[0].pageY};f.update();break;case 2:if(!0===f.noZoom)break;if(x!==w.TOUCH_DOLLY)break;d=a.touches[0].pageX-a.touches[1].pageX;a=a.touches[0].pageY-a.touches[1].pageY;z.set(0,Math.sqrt(d*d+a*a));T.subVectors(z,y);0>T.y?(f.object.fov=f.object.fov<f.maxFov?f.object.fov+1:f.maxFov,f.object.updateProjectionMatrix()):0<T.y&&(f.object.fov=
f.object.fov>f.minFov?f.object.fov-1:f.minFov,f.object.updateProjectionMatrix());y.copy(z);f.update();f.dispatchEvent(V);break;case 3:if(!0===f.noPan)break;if(x!==w.TOUCH_PAN)break;U.set(a.touches[0].pageX,a.touches[0].pageY);t.subVectors(U,n);f.pan(t.x,t.y);n.copy(U);f.update();break;default:x=w.NONE}}}function q(){Q=!0;G=void 0;!1!==f.enabled&&(f.dispatchEvent(P),x=w.NONE)}this.object=a;this.domElement=void 0!==b?b:document;this.frameId=null;this.enabled=!0;this.center=this.target=new e.Vector3;
this.noZoom=!1;this.zoomSpeed=1;this.minDistance=0;this.maxDistance=Infinity;this.minZoom=0;this.maxZoom=Infinity;this.noRotate=!1;this.rotateSpeed=-.15;this.noPan=!0;this.keyPanSpeed=7;this.autoRotate=!1;this.autoRotateSpeed=2;this.minPolarAngle=0;this.maxPolarAngle=Math.PI;this.momentumDampingFactor=.9;this.momentumScalingFactor=-.005;this.momentumKeydownFactor=20;this.minFov=30;this.maxFov=120;this.minAzimuthAngle=-Infinity;this.maxAzimuthAngle=Infinity;this.noKeys=!1;this.keys={LEFT:37,UP:38,
RIGHT:39,BOTTOM:40};this.mouseButtons={ORBIT:e.MOUSE.LEFT,ZOOM:e.MOUSE.MIDDLE,PAN:e.MOUSE.RIGHT};var f=this,E=new e.Vector2,h=new e.Vector2,r=new e.Vector2,n=new e.Vector2,U=new e.Vector2,t=new e.Vector2,u=new e.Vector3,A=new e.Vector3,y=new e.Vector2,z=new e.Vector2,T=new e.Vector2,R=0,H=0,B=0,C=0,D=1,F=new e.Vector3,M=new e.Vector3,N=new e.Quaternion,K=0,L=0,G,Q=!1,I,J,X,Y,w={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_DOLLY:4,TOUCH_PAN:5},x=w.NONE;this.target0=this.target.clone();this.position0=
this.object.position.clone();this.zoom0=this.object.zoom;var S=(new e.Quaternion).setFromUnitVectors(a.up,new e.Vector3(0,1,0)),W=S.clone().inverse(),V={type:"change"},O={type:"start"},P={type:"end"};this.setLastQuaternion=function(a){N.copy(a);f.object.quaternion.copy(a)};this.getLastPosition=function(){return M};this.rotateLeft=function(a){void 0===a&&(a=2*Math.PI/60/60*f.autoRotateSpeed);C-=a};this.rotateUp=function(a){void 0===a&&(a=2*Math.PI/60/60*f.autoRotateSpeed);B-=a};this.panLeft=function(a){var d=
this.object.matrix.elements;u.set(d[0],d[1],d[2]);u.multiplyScalar(-a);F.add(u)};this.panUp=function(a){var d=this.object.matrix.elements;u.set(d[4],d[5],d[6]);u.multiplyScalar(a);F.add(u)};this.pan=function(a,d){var b=f.domElement===document?f.domElement.body:f.domElement;if(f.object instanceof e.PerspectiveCamera){var c=f.object.position.clone().sub(f.target).length();c*=Math.tan(f.object.fov/2*Math.PI/180);f.panLeft(2*a*c/b.clientHeight);f.panUp(2*d*c/b.clientHeight)}else f.object instanceof e.OrthographicCamera?
(f.panLeft(a*(f.object.right-f.object.left)/b.clientWidth),f.panUp(d*(f.object.top-f.object.bottom)/b.clientHeight)):console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.")};this.momentum=function(){Q&&(1E-4>Math.abs(K)&&1E-4>Math.abs(L)?Q=!1:(L*=this.momentumDampingFactor,K*=this.momentumDampingFactor,C-=this.momentumScalingFactor*K,B-=this.momentumScalingFactor*L))};this.dollyIn=function(a){void 0===a&&(a=Math.pow(.95,f.zoomSpeed));f.object instanceof e.PerspectiveCamera?
D/=a:f.object instanceof e.OrthographicCamera?(f.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom*a)),f.object.updateProjectionMatrix(),f.dispatchEvent(V)):console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.")};this.dollyOut=function(a){void 0===a&&(a=Math.pow(.95,f.zoomSpeed));f.object instanceof e.PerspectiveCamera?D*=a:f.object instanceof e.OrthographicCamera?(f.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/
a)),f.object.updateProjectionMatrix(),f.dispatchEvent(V)):console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.")};this.update=function(a){var d=this.object.position;A.copy(d).sub(this.target);A.applyQuaternion(S);R=Math.atan2(A.x,A.z);H=Math.atan2(Math.sqrt(A.x*A.x+A.z*A.z),A.y);this.autoRotate&&x===w.NONE&&this.rotateLeft(2*Math.PI/60/60*f.autoRotateSpeed);this.momentum();R+=C;H+=B;R=Math.max(this.minAzimuthAngle,Math.min(this.maxAzimuthAngle,R));H=Math.max(this.minPolarAngle,
Math.min(this.maxPolarAngle,H));H=Math.max(1E-7,Math.min(Math.PI-1E-7,H));var b=A.length()*D;b=Math.max(this.minDistance,Math.min(this.maxDistance,b));this.target.add(F);A.x=b*Math.sin(H)*Math.sin(R);A.y=b*Math.cos(H);A.z=b*Math.sin(H)*Math.cos(R);A.applyQuaternion(W);d.copy(this.target).add(A);this.object.lookAt(this.target);B=C=0;D=1;F.set(0,0,0);if(1E-7<M.distanceToSquared(this.object.position)||1E-7<8*(1-N.dot(this.object.quaternion)))!0!==a&&this.dispatchEvent(V),M.copy(this.object.position),
N.copy(this.object.quaternion)};this.reset=function(){x=w.NONE;this.target.copy(this.target0);this.object.position.copy(this.position0);this.object.zoom=this.zoom0;this.object.updateProjectionMatrix();this.dispatchEvent(V);this.update()};this.getPolarAngle=function(){return H};this.getAzimuthalAngle=function(){return R};this.connect=function(){this.domElement.addEventListener("mousedown",c,{passive:!1});this.domElement.addEventListener("mousewheel",k,{passive:!1});this.domElement.addEventListener("DOMMouseScroll",
k,{passive:!1});this.domElement.addEventListener("touchstart",l,{passive:!1});this.domElement.addEventListener("touchend",q,{passive:!1});this.domElement.addEventListener("touchmove",v,{passive:!1});window.addEventListener("keyup",p,{passive:!1});window.addEventListener("keydown",m,{passive:!1})};this.disconnect=function(){this.domElement.removeEventListener("mousedown",c);this.domElement.removeEventListener("mousewheel",k);this.domElement.removeEventListener("DOMMouseScroll",k);this.domElement.removeEventListener("touchstart",
l);this.domElement.removeEventListener("touchend",q);this.domElement.removeEventListener("touchmove",v);window.removeEventListener("keyup",p);window.removeEventListener("keydown",m)};this.dispose=function(){this.disconnect()};this.update()}function ca(a,b){var c=this,d={type:"change"},g=0,k=0,p=0,m=0;this.camera=a;this.camera.rotation.reorder("YXZ");this.domElement=void 0!==b?b:document;this.enabled=!0;this.gyroPermissionGranted=!1;this.deviceOrientation={};this.alphaOffsetAngle=this.alpha=this.screenOrientation=
0;var l=function(a){c.deviceOrientation=a},v=function(){c.screenOrientation=window.orientation||0},q=function(a){a.preventDefault();a.stopPropagation();p=a.touches[0].pageX;m=a.touches[0].pageY},f=function(a){a.preventDefault();a.stopPropagation();g+=e.Math.degToRad((a.touches[0].pageX-p)/4);k+=e.Math.degToRad((m-a.touches[0].pageY)/4);c.updateAlphaOffsetAngle(g);p=a.touches[0].pageX;m=a.touches[0].pageY};this.connect=function(){v();window.addEventListener("orientationchange",v,{passive:!0});window.addEventListener("deviceorientation",
l,{passive:!0});window.addEventListener("deviceorientation",this.update.bind(this),{passive:!0});this.domElement.addEventListener("touchstart",q,{passive:!1});this.domElement.addEventListener("touchmove",f,{passive:!1});this.enabled=!0};this.disconnect=function(){window.removeEventListener("orientationchange",v,!1);window.removeEventListener("deviceorientation",l,!1);window.removeEventListener("deviceorientation",this.update.bind(this),!1);c.domElement.removeEventListener("touchstart",q,!1);c.domElement.removeEventListener("touchmove",
...
r=new e.Quaternion;if(0==c.screenOrientation){var n=new e.Vector3(1,0,0);h.setFromAxisAngle(n,-k)}else 180==c.screenOrientation?(n=new e.Vector3(1,0,0),h.setFromAxisAngle(n,k)):90==c.screenOrientation?(n=new e.Vector3(0,1,0),h.setFromAxisAngle(n,k)):-90==c.screenOrientation&&(n=new e.Vector3(0,1,0),h.setFromAxisAngle(n,-k));v.multiply(h);v.multiply(r);E.set(g,b,-f,"YXZ");m.setFromEuler(E);m.multiply(v);m.multiply(q.setFromAxisAngle(l,-p));c.alpha=b;!0!==a&&c.dispatchEvent(d)}};this.updateAlphaOffsetAngle=
function(a){this.alphaOffsetAngle=a;this.update()};this.dispose=function(){this.disconnect()}}function ha(a){var b=new e.OrthographicCamera(-1,1,1,-1,0,1),c=new e.Scene,d=new e.StereoCamera;d.aspect=.5;var g=new e.WebGLRenderTarget(512,512,{minFilter:e.LinearFilter,magFilter:e.NearestFilter,format:e.RGBAFormat});g.scissorTest=!0;g.texture.generateMipmaps=!1;var k=new e.Vector2(.441,.156),p=(new e.PlaneBufferGeometry(1,1,10,20)).removeAttribute("normal").toNonIndexed(),m=p.attributes.position.array,
l=p.attributes.uv.array;p.attributes.position.count*=2;p.attributes.uv.count*=2;var v=new Float32Array(2*m.length);v.set(m);v.set(m,m.length);var q=new Float32Array(2*l.length);q.set(l);q.set(l,l.length);l=new e.Vector2;m=m.length/3;for(var f=0,E=v.length/3;f<E;f++){l.x=v[3*f];l.y=v[3*f+1];var h=l.dot(l);h=1.5+(k.x+k.y*h)*h;var n=f<m?0:1;v[3*f]=l.x/h*1.5-.5+n;v[3*f+1]=l.y/h*3;q[2*f]=.5*(q[2*f]+n)}p.attributes.position.array=v;p.attributes.uv.array=q;k=new e.MeshBasicMaterial({map:g.texture});p=new e.Mesh(p,
k);c.add(p);this.setSize=function(d,b){a.setSize(d,b);var c=a.getPixelRatio();g.setSize(d*c,b*c)};this.render=function(k,f){k.updateMatrixWorld();null===f.parent&&f.updateMatrixWorld();d.update(f);f=g.width/2;var e=g.height;a.autoClear&&a.clear();g.scissor.set(0,0,f,e);g.viewport.set(0,0,f,e);a.setRenderTarget(g);a.render(k,d.cameraL);a.clearDepth();g.scissor.set(f,0,f,e);g.viewport.set(f,0,f,e);a.setRenderTarget(g);a.render(k,d.cameraR);a.clearDepth();a.setRenderTarget(null);a.render(c,b)}}function da(a){a=
...
d}else console.warn("Widget container not set")},createDefaultMenu:function(){var a=this;var b=function(b,d){return function(){a.dispatchEvent({type:"panolens-viewer-handler",method:b,data:d})}};return[{title:"Control",subMenu:[{title:this.TOUCH_ENABLED?"Touch":"Mouse",handler:b("enableControl",D.ORBIT)},{title:"Sensor",handler:b("enableControl",D.DEVICEORIENTATION)}]},{title:"Mode",subMenu:[{title:"Normal",handler:b("disableEffect")},{title:"Cardboard",handler:b("enableEffect",t.CARDBOARD)},{title:"Stereoscopic",
...
a.onTap&&c.addEventListener(b.TOUCH_ENABLED?"touchend":"click",a.onTap,!1);c.dispose=function(){c.removeEventListener(b.TOUCH_ENABLED?"touchend":"click",a.onTap,!1);if(d)a.onDispose()};return c},mergeStyleOptions:function(a,b){b=void 0===b?{}:b;for(var c in b)b.hasOwnProperty(c)&&(a.style[c]=b[c]);return a},dispose:function(){this.barElement&&(this.container.removeChild(this.barElement),this.barElement.dispose(),this.barElement=null)}});n.prototype=Object.assign(Object.create(e.Object3D.prototype),
{constructor:n,add:function(a){if(1<arguments.length){for(var b=0;b<arguments.length;b++)this.add(arguments[b]);return this}a instanceof z&&a.dispatchEvent&&((b=this.container)&&a.dispatchEvent({type:"panolens-container",container:b}),a.dispatchEvent({type:"panolens-infospot-focus",method:function(a,b,e){this.dispatchEvent({type:"panolens-viewer-handler",method:"tweenControlCenter",data:[a,b,e]})}.bind(this)}));e.Object3D.prototype.add.call(this,a)},load:function(){this.onLoad()},onClick:function(a){a.intersects&&
0===a.intersects.length&&this.traverse(function(a){a.dispatchEvent({type:"dismiss"})})},setContainer:function(a){if(a instanceof HTMLElement)var b=a;else a&&a.container&&(b=a.container);b&&(this.children.forEach(function(a){a instanceof z&&a.dispatchEvent&&a.dispatchEvent({type:"panolens-container",container:b})}),this.container=b)},onLoad:function(){this.loaded=!0;this.dispatchEvent({type:"load"})},onProgress:function(a){this.dispatchEvent({type:"progress",progress:a})},onError:function(){this.dispatchEvent({type:"error"})},
getZoomLevel:function(){return 800>=window.innerWidth?this.ImageQualityFair:800<window.innerWidth&&1280>=window.innerWidth?this.ImageQualityMedium:1280<window.innerWidth&&1920>=window.innerWidth?this.ImageQualityHigh:1920<window.innerWidth?this.ImageQualitySuperHigh:this.ImageQualityLow},updateTexture:function(a){this.background.material.map=a;this.background.material.needsUpdate=!0},toggleInfospotVisibility:function(a,b){b=void 0!==b?b:0;var c=void 0!==a?a:this.isInfospotVisible?!1:!0;this.traverse(function(a){a instanceof
z&&(c?a.show(b):a.hide(b))});this.isInfospotVisible=c;this.infospotAnimation.onComplete(function(){this.dispatchEvent({type:"infospot-animation-complete",visible:c})}.bind(this)).delay(b).start()},setLinkingImage:function(a,b){this.linkingImageURL=a;this.linkingImageScale=b},link:function(a,b,c,d){this.visible=!0;b?(c=void 0!==c?c:void 0!==a.linkingImageScale?a.linkingImageScale:300,d=d?d:a.linkingImageURL?a.linkingImageURL:u.Arrow,d=new z(c,d),d.position.copy(b),d.toPanorama=a,d.addEventListener("click",
function(){this.dispatchEvent({type:"panolens-viewer-handler",method:"setPanorama",data:a})}.bind(this)),this.linkedSpots.push(d),this.add(d),this.visible=!1):console.warn("Please specify infospot position for linking")},reset:function(){this.children.length=0},setupTransitions:function(){this.fadeInAnimation=(new r.Tween(this.background.material)).easing(r.Easing.Quartic.Out).onStart(function(){this.visible=!0;this.dispatchEvent({type:"enter-fade-start"})}.bind(this));this.fadeOutAnimation=(new r.Tween(this.background.material)).easing(r.Easing.Quartic.Out).onComplete(function(){this.visible=
!1;this.dispatchEvent({type:"leave-complete"})}.bind(this));this.enterTransition=(new r.Tween(this)).easing(r.Easing.Quartic.Out).onComplete(function(){this.dispatchEvent({type:"enter-complete"})}.bind(this)).start();this.leaveTransition=(new r.Tween(this)).easing(r.Easing.Quartic.Out)},onFadeAnimationUpdate:function(){this.background.material&&this.background.material.uniforms&&this.background.material.uniforms.opacity&&(uniforms.opacity.value=this.background.material.opacity)},fadeIn:function(a){a=
0<=a?a:this.animationDuration;this.fadeOutAnimation.stop();this.fadeInAnimation.to({opacity:1},a).onUpdate(this.onFadeAnimationUpdate.bind(this)).onComplete(function(){this.toggleInfospotVisibility(!0,a/2);this.dispatchEvent({type:"enter-fade-complete"})}.bind(this)).start()},fadeOut:function(a){a=0<=a?a:this.animationDuration;this.fadeInAnimation.stop();this.fadeOutAnimation.to({opacity:0},a).onUpdate(this.onFadeAnimationUpdate.bind(this)).start()},onEnter:function(){var a=this.animationDuration;
...
this.dispatchEvent({type:"leave"});this.children.forEach(function(a){a.dispatchEvent({type:"panorama-leave"})});this.active=!1},dispose:function(){function a(b){for(var c=b.geometry,d=b.material,e=b.children.length-1;0<=e;e--)a(b.children[e]),b.remove(b.children[e]);b instanceof z&&b.dispose();c&&(c.dispose(),b.geometry=null);d&&(d.dispose(),b.material=null)}this.infospotAnimation.stop();this.fadeInAnimation.stop();this.fadeOutAnimation.stop();this.enterTransition.stop();this.leaveTransition.stop();
this.dispatchEvent({type:"panolens-viewer-handler",method:"onPanoramaDispose",data:this});a(this);this.parent&&this.parent.remove(this)}});y.prototype=Object.assign(Object.create(n.prototype),{constructor:y,load:function(a){a=a||this.src;if(!a)console.warn("Image source undefined");else if("string"===typeof a)N.load(a,this.onLoad.bind(this),this.onProgress.bind(this),this.onError.bind(this));else if(a instanceof HTMLImageElement)this.onLoad(new e.Texture(a))},onLoad:function(a){a.minFilter=a.magFilter=
e.LinearFilter;a.needsUpdate=!0;this.updateTexture(a);window.requestAnimationFrame(n.prototype.onLoad.bind(this))},reset:function(){n.prototype.reset.call(this)},dispose:function(){var a=this.background.material.map;e.Cache.remove(this.src);a&&a.dispose();n.prototype.dispose.call(this)}});W.prototype=Object.assign(Object.create(n.prototype),{constructor:W});F.prototype=Object.assign(Object.create(n.prototype),{constructor:F,load:function(){fa.load(this.images,this.onLoad.bind(this),this.onProgress.bind(this),
this.onError.bind(this))},onLoad:function(a){this.background.material.uniforms.tCube.value=a;n.prototype.onLoad.call(this)},dispose:function(){var a=this.background.material.uniforms.tCube.value;this.images.forEach(function(a){e.Cache.remove(a)});a instanceof e.CubeTexture&&a.dispose();n.prototype.dispose.call(this)}});O.prototype=Object.assign(Object.create(F.prototype),{constructor:O});B.prototype=Object.assign(Object.create(n.prototype),{constructor:B,isMobile:function(){var a=!1,b=window.navigator.userAgent||
...
!1},onMouseWheel:function(a){a.preventDefault();a.stopPropagation();var b=0;void 0!==a.wheelDelta?b=a.wheelDelta:void 0!==a.detail&&(b=-a.detail);this.addZoomDelta(b);this.onUpdateCallback()},addZoomDelta:function(a){var b=this.background.material.uniforms,c=.1*this.size,d=10*this.size;b.zoom.value+=a;b.zoom.value<=c?b.zoom.value=c:b.zoom.value>=d&&(b.zoom.value=d)},onUpdateCallback:function(){this.frameId=window.requestAnimationFrame(this.onUpdateCallback.bind(this));this.quatSlerp.slerp(this.quatCur,
.1);this.background.material&&this.background.material.uniforms.transform.value.makeRotationFromQuaternion(this.quatSlerp);!this.dragging&&1-this.quatSlerp.clone().dot(this.quatCur)<this.EPS&&window.cancelAnimationFrame(this.frameId)},reset:function(){this.quatCur.set(0,0,0,1);this.quatSlerp.set(0,0,0,1);this.onUpdateCallback()},onLoad:function(a){this.background.material.uniforms.resolution.value=this.container.clientWidth/this.container.clientHeight;this.registerMouseEvents();this.onUpdateCallback();
this.dispatchEvent({type:"panolens-viewer-handler",method:"disableControl"});y.prototype.onLoad.call(this,a)},onLeave:function(){this.unregisterMouseEvents();this.dispatchEvent({type:"panolens-viewer-handler",method:"enableControl",data:D.ORBIT});window.cancelAnimationFrame(this.frameId);y.prototype.onLeave.call(this)},onWindowResize:function(){this.background.material.uniforms.resolution.value=this.container.clientWidth/this.container.clientHeight},onContextMenu:function(){this.dragging=!1},dispose:function(){this.unregisterMouseEvents();
y.prototype.dispose.call(this)}});aa.prototype=Object.assign(Object.create(C.prototype),{constructor:aa,onLoad:function(a){this.updateTexture(a);C.prototype.onLoad.call(this,a)},updateTexture:function(a){a.minFilter=a.magFilter=e.LinearFilter;this.background.material.uniforms.tDiffuse.value=a},dispose:function(){var a=this.background.material.uniforms.tDiffuse;a&&a.value&&a.value.dispose();C.prototype.dispose.call(this)}});J.prototype=Object.assign(Object.create(n.prototype),{constructor:J,onPanolensContainer:function(a){this.media.setContainer(a.container)},
...
setCameraControl:function(){this.OrbitControls.target.copy(this.panorama.position)},getControl:function(){return this.control},getScene:function(){return this.scene},getCamera:function(){return this.camera},getRenderer:function(){return this.renderer},getContainer:function(){return this.container},getControlId:function(){return this.control.id},getControlIndex:function(){return this.controls.indexOf(this.control)},getNextControlId:function(){return this.controls[this.getNextControlIndex()].id},getNextControlIndex:function(){var a=
this.controls,b=this.getControlIndex()+1;return b>=a.length?0:b},setCameraFov:function(a){this.camera.fov=a;this.camera.updateProjectionMatrix()},enableControl:function(a){a=0<=a&&a<this.controls.length?a:0;this.control&&(this.control.enabled=!1,this.control.disconnect());this.control=this.controls[a];this.control.enabled=!0;this.control.connect();if(this.panorama)switch(a){case D.ORBIT:this.camera.position.copy(this.panorama.position);this.camera.position.z+=1;break;case D.DEVICEORIENTATION:this.camera.position.copy(this.panorama.position)}this.control.update();
this.activateWidgetItem(a,void 0)},disableControl:function(){this.control.enabled=!1},toggleNextControl:function(){this.enableControl(this.getNextControlIndex())},getScreenVector:function(a){a=a.clone();var b=this.container.clientWidth/2,c=this.container.clientHeight/2;a.project(this.camera);a.x=a.x*b+b;a.y=-(a.y*c)+c;a.z=0;return a},getCameraHeading:function(){var a=new e.Vector3;this.camera.getWorldDirection(a);return Math.atan2(a.z,a.x)+e.Math.degToRad(180)},checkSpriteInViewport:function(a){this.camera.matrixWorldInverse.getInverse(this.camera.matrixWorld);
...
centreActivePanorama:function(){var a=this.getCameraHeading();this.panorama.rotation.y=-1*a},tweenControlCenter:function(a,b,c){var d;if(this.control===this.OrbitControls){a instanceof Array&&(b=a[1],c=a[2],a=a[0]);b=void 0!==b?b:1E3;c=c||r.Easing.Exponential.Out;var g=this;var k=this.camera.getWorldDirection(new e.Vector3);var h=k.clone();var m=this.panorama.getWorldPosition(new e.Vector3).sub(this.camera.getWorldPosition(new e.Vector3));a=a.clone();a.add(m).normalize();var l=a.clone();k.y=0;a.y=
0;m=Math.atan2(a.z,a.x)-Math.atan2(k.z,k.x);m=m>Math.PI?m-2*Math.PI:m;m=m<-Math.PI?m+2*Math.PI:m;k=Math.abs(h.angleTo(k)+(0>=h.y*l.y?l.angleTo(a):-l.angleTo(a)));k*=l.y<h.y?1:-1;h={left:0,up:0};var n=d=0;this.tweenLeftAnimation.stop();this.tweenUpAnimation.stop();this.tweenLeftAnimation=(new r.Tween(h)).to({left:m},b).easing(c).onUpdate(function(a){g.control.rotateLeft(a.left-d);d=a.left}).start();this.tweenUpAnimation=(new r.Tween(h)).to({up:k},b).easing(c).onUpdate(function(a){g.control.rotateUp(a.up-
n);n=a.up}).start()}},tweenControlCenterByObject:function(a,b,c){this.tweenControlCenter(a.getWorldPosition(new e.Vector3),b,c)},onWindowResize:function(a,b){var c=this.container.classList.contains("panolens-container")||this.container.isFullscreen;if(void 0!==a&&void 0!==b){var d=a;var e=b;this.container._width=a;this.container._height=b}else a=(b=/(android)/i.test(window.navigator.userAgent))?Math.min(document.documentElement.clientWidth,window.innerWidth||0):Math.max(document.documentElement.clientWidth,
...
e&&e.dispatchEvent&&e.dispatchEvent({type:"click",mouseEvent:a});else{this.panorama.dispatchEvent({type:"hover",intersects:c,mouseEvent:a});if(this.hoverObject&&0<c.length&&this.hoverObject!==d||this.hoverObject&&0===c.length)this.hoverObject.dispatchEvent&&(this.hoverObject.dispatchEvent({type:"hoverleave",mouseEvent:a}),this.reticle.end()),this.hoverObject=void 0;d&&0<c.length&&(this.hoverObject!==d&&(this.hoverObject=d,this.hoverObject.dispatchEvent&&(this.hoverObject.dispatchEvent({type:"hoverenter",
